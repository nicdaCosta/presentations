define( 'audioTag' , ['utils'] , function( utils ) {
	...
	var elemHTMLAudio = function( sourceURL , spriteName , spriteMap , loadCallback  ) {
		// instatiate
	...
	var _load = function( spriteName ) {
		...
		this.play( { spriteName : spriteName } );
	...
	var _add = function( sourceURL , spriteName ) {
		...
		var _initLoad = function( e ) {
			...
			console.warn('initLoading. calling load');

			// remove eventListeners
			window.removeEventListener( 'touchStart' , _initLoad , false );
			window.removeEventListener( 'MSPointerUp' , _initLoad , false );
		...
		window.addEventListener( 'MSPointerUp' , _initLoad , false  );
	...
	var proto = elemHTMLAudio.prototype;
